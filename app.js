const artists = [
    ...
    { name: "CHERNELLA", role: "Hip-Hop", img: "photo_2026-05-16_04-00-07.jpg", desc: "Артист, который не ищет легких путей и транслирует в творчестве реальную жизнь без выдуманных легенд. CHERNELLA — это фирменный голос, самобытный стиль и absolute уверенность в каждом треке.", links: [{ title: "LINK", url: "https://t.me/cherne11aa" }] },
    ...
    { name: "FRXNT Prod", role: "Bass House/G-House", img: "IMG_0121.JPG", desc: "Талантливый саунд-продюсер, специализирующийся на актуальных жанрах электронной танцевальной музыки. Его треки созданы для того, чтобы задавать ритм танцполу и держать публику в постоянном движении. Мастодонт жанра G-House в СНГ.", links: [{ title: "LINK", url: "https://t.me/FRXNTPROD" }] },
...
artists.forEach((artist, index) => {
    ...
    card.innerHTML = `
        ...
        <div class="artist-img-placeholder">
            <img src="${artist.img}" alt="${artist.name}" onerror="this.src='https://placehold.co/400x500/111215/39ff14?text=${artist.name}'">
        </div>
